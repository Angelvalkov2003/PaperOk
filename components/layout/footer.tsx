...
export default function Footer() {
  ...
  return (
    ...
    <footer className="animate-fade-in relative z-0 overflow-hidden border-t border-paper-border-strong/70 bg-paper-footer text-sm text-paper-text">
      ...
      <div className="relative z-10 border-t border-paper-green-hover/30 bg-paper-green-hover py-6">

        <div className="mx-auto flex w-full max-w-7xl flex-col items-center justify-between gap-2 px-6 text-xs text-white/90 sm:flex-row lg:px-8">
